...
ACTIVE_GEMINI_MODEL = 'gemini-1.5-flash' # Padrão inicial

def select_best_gemini_model():
    """Testa qual modelo do Gemini está respondendo corretamente na inicialização."""
...
init_db()
select_best_gemini_model() # Verifica qual IA está funcionando ao iniciar
